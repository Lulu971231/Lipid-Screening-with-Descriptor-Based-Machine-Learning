...
| coma_l   | string  | Aldehyde tail component identifier (references basic_smiles.csv) |
| comP1_P8 | string  | Phosphate linker identifier (references basic_smiles.csv)        |
| com1_20  | string  | Amine head component identifier (references basic_smiles.csv)    |
